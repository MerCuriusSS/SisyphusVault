...
可能追问点：
- TPS结果如何得出？
  非精确答案，只是合理推导。本地造数、队列满载的条件下，TPS可达25万TPS/s，结合瓶颈位在单线程写入磁盘的结论，得出本地磁盘吞吐量约为250MB/S，生产环境中的NAS盘，常规吞吐量大概为50MB/s，再算上OS其他操作损耗、网络延迟等打3-5折，也有150MB/s，预估2.4万TPS/s，绰绰有余甚至偏保守。
